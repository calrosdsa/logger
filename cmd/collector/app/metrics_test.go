...
// 	"logger/internal/metricstest"
// 	"logger/model"
// 	jaegerM "logger/pkg/metrics"
// )
...
// 	spm := NewSpanProcessorMetrics(serviceMetrics, hostMetrics, []processor.LogFormat{processor.LogFormat("scruffy")})
...
// 	grpcChannelFormat := spm.GetCountsForFormat(processor.LogFormat, processor.GRPCTransport)
// 	assert.NotNil(t, grpcChannelFormat)
// 	grpcChannelFormat.ReceivedBySvc.ReportServiceNameForSpan(&model.LogRecord{
// 		Process: &model.Process{},
// 	})
// 	mSpan := model.LogRecord{
// 		Process: &model.Process{
// 			ServiceName: "fry",
// 		},
// 	}
