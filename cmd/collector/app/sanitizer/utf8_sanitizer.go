...
// func (s *utf8Sanitizer) Sanitize(span *model.LogRecord) *model.LogRecord {
...
// func (s *utf8Sanitizer) logSpan(span *model.LogRecord, message string, field zapcore.Field) {
// 	s.logger.Info(
// 		message,
