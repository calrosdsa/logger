...
// 		},
// 	)
// 	_, exists := pb.KeyValues(actual.Process.Tags).FindByKey(invalidTagKey)
...
// 		},
// 	)
// 	_, exists := pb.KeyValues(actual.Tags).FindByKey(invalidTagKey)
// 	assert.True(t, exists)
// }
