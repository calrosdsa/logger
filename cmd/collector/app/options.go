...
type options struct {
	...
	reportBusy             bool
	extraFormatTypes       []processor.LogFormat
	collectorTags          map[string]string
	spanSizeMetricsEnabled bool
	onDroppedSpan          func(span *model.LogRecord)
}
...
func (options) PreProcessSpans(preProcessSpans ProcessLogs) Option {
	return func(b *options) {
...
func (options) PreSave(preSave ProcessLog) Option {
	return func(b *options) {
		b.preSave = preSave
	}
}
...
func (options) ExtraFormatTypes(extraFormatTypes []processor.LogFormat) Option {
	return func(b *options) {
...
func (options) OnDroppedSpan(onDroppedSpan func(span *model.LogRecord)) Option {
	return func(b *options) {
...
func (o options) apply(opts ...Option) options {
	...
	if ret.preProcessSpans == nil {
		ret.preProcessSpans = func(spans []*model.LogRecord, tenant string) {}
	}
	if ret.sanitizer == nil {
		ret.sanitizer = func(span *model.LogRecord) *model.LogRecord { return span }
	}
	if ret.preSave == nil {
